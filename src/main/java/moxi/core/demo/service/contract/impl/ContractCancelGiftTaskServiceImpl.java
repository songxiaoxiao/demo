 ...
 */
@Service
public class ContractCancelGiftTaskServiceImpl extends ServiceImpl<TContractPlanChangeMapper, TContractPlanChange> implements ITContractPlanChangeService {
    ...
    public void contractPlanChange(@Validated ContractPlanChangeDO contractPlanChangeDO){
        ...
        //操作类型
        contractPlanChange.setType(CommonConstants.CONTRACT_PLAN_CANCEL_GIFT_TASK);
