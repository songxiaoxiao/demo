 ...
 */
@Service
public class ContractCompleteTaskServiceImpl extends ServiceImpl<TContractPlanChangeMapper, TContractPlanChange> implements ITContractPlanChangeService {
    ...
    public void contractPlanChange(@Validated ContractPlanChangeDO contractPlanChangeDO){
        ...
        if (contractPlanChange1 == null || contractPlanChange1.getRemainingPeriod() <= 0) throw new AppRuntimeException(400, "没有剩余任务");
        ...
        //操作类型
        contractPlanChange.setType(CommonConstants.CONTRACT_PLAN_COMPLETE_TASK);
